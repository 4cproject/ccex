...
class CCExControllersContact extends JControllerBase
{
    public function execute() {
        ...
        if (array_key_exists("recipient_organization_id", $data) && array_key_exists("message", $data) && $contactModel->contact($organization->organization_id, $data["recipient_organization_id"], $data["message"])) {
