  ...
  **/
  ...
  private function seriesData($intervals, $beginYear, $number){
    $data = array(
      ...
      "cat_financial_accounting_other"  => array_fill(0, $number, 0),
      "cat_production"                  => array_fill(0, $number, 0),
      "cat_ingest"                      => array_fill(0, $number, 0),
      "cat_storage"                     => array_fill(0, $number, 0),
      "cat_access"                      => array_fill(0, $number, 0),
      "cat_activities_other"            => array_fill(0, $number, 0)
    );
