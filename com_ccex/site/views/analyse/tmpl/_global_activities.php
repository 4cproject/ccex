<div class="container">
    ...
    <p>
        ...
        <br/>
        <a target="_blank" href="<?php echo JRoute::_('/ccex/index.php/62-analyse-and-compare-costs#global_activities'); ?>">Learn more about how these results are calculated.</a>
    </p>
</div>
<br/>
