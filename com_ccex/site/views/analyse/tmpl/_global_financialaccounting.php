<div class="tour-step tour-step-global-purchases">
    ...
    <p>
      This graph takes an average total spend for all years and either compares an aggregated figure for all your data sets or selected data sets, with other cost data sets shared with the CCEx. Hover on each bar or use the key to identify your relative cost per gigabyte for the total period of each cost data set, in terms of a purchases and staff breakdown. The figure at the head of the bar for each year also shows your relative cost per gigabyte for the total period of each cost data set.       You can export your data by clicking the icon in the top right hand corner of this graph.
