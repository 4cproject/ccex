<div class="container">
    <h3>Activities</h3>
    <div id="self_activities_chart" class="col-md-12" style="width: 1140px; height: 400px;margin-top:20px"></div>
    <div id="self_activities_master_chart" class="col-md-12" style="width: 1140px; height: 100px;margin-bottom:20px;<?php if(!$this->master){ echo 'display:none;'; } ?>"></div>

    <p>
        This graph provides an overview of your aggregated costs from the data sets you selected. Hover on each section of the bar or use the key to identify the areas in which you have invested. The figure at the head of the bar for each year shows your total spend per year. Use the grey slider beneath the graph to select and display results for up to five years at a time.
        <br/>
        <a target="_blank" href="<?php echo JRoute::_('/ccex/index.php/62-analyse-and-compare-costs#self_activities'); ?>">Learn more about how these results are calculated.</a>
        <br/>
