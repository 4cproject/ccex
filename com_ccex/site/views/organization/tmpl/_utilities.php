<div class="container">
    <div class="row">
        ...
        <div class="col-md-3 col-md-offset-6">
            <div id="analyse-btn-ready" style="<?php if(!$this->organization->readyForComparison()){ echo "display: none"; } ?>" data-toggle="tooltip" data-placement="top" title="Click here to see the summary of your submitted costs and compare them with other organisations">
