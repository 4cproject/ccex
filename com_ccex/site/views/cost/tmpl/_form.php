<form class="form-horizontal" id="costForm" role="form">
	...
	<div class="form-group">
		...
		<?php if($this->currency->code != "EUR"){ ?>
			<div class="col-sm-6" id="cost-converted" style="padding-top: 5px;<?php if(!isset($this->cost->cost)){ echo "display: none;"; } ?>">
				<small>This cost will be converted to <strong>€</strong><strong id="cost-euro"><?php if(isset($this->cost->cost)){ echo number_format($this->cost->cost * $this->tax, 2); } ?></strong> for global and peer comparison. <button type="button" class="popover-dismiss tooltip-button" data-toggle="popover" title="Currency convertion" data-content="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."><i class="fa fa-info-circle"></i></button></small>
			</div>
		<?php } ?>
	</div>
	<br/>
	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="form-group">
				<label for="cat_it-developer" class="col-sm-4 control-label"><button type="button" class="popover-dismiss tooltip-button" data-toggle="popover" title="IT-developer" data-content="Staff members who develop software. Software engineers, programmers, system developers, coders.">IT-developer <i class="fa fa-info-circle small"></i></button></label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label for="cat_manager" class="col-sm-4 control-label"><button type="button" class="popover-dismiss tooltip-button" data-toggle="popover" title="Manager" data-content="Staff members who organise and plan the work of digital curation in their organisation. Make tactical and strategic decisions, have staff responsibility and do budgeting.">Manager <i class="fa fa-info-circle small"></i></button></label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label for="cat_overhead" class="col-sm-4 control-label"><button type="button" class="popover-dismiss tooltip-button" data-toggle="popover" title="Overhead" data-content="All costs pertaining to overhead costs such as building costs, electricity, water, etc.">Overhead <i class="fa fa-info-circle small"></i></button></label>
				<div class="col-sm-8">
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				<label for="cat_pre_ingest" class="col-sm-4 control-label"><button type="button" class="popover-dismiss tooltip-button" data-toggle="popover" title="Pre-Ingest" data-content="Digital content production involves any activity related to the preparation of digital assets for archiving. This might encompass digitisation, extraction of data from databases, metadata enrichment, migration of production formats to preservation formats, etc.">Pre-Ingest <i class="fa fa-info-circle small"></i></button></label>
				<div class="col-sm-8">
