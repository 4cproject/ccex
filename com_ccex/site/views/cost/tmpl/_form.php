<form class="form-horizontal" id="costForm" role="form">
	<div class="tour-step tour-step-cost-name-description">
	...
	<div>
		...
		<div class="col-sm-3 form-group tour-step tour-step-cost-cost">
			<div class="row" style="margin-right: -30px;">
				<label for="cost_value" class="col-sm-4 control-label">Cost</label>
				<div class="col-sm-8">
		...
		<?php if($this->currency->code != "EUR"){ ?>
			<div class="col-sm-6" id="cost-converted" style="padding-top: 5px;<?php if(!isset($this->cost->cost)){ echo "display: none;"; } ?>">
				<small>This cost will be converted to <strong>€</strong><strong id="cost-euro"><?php if(isset($this->cost->cost)){ echo number_format($this->cost->cost * $this->tax, 2); } ?></strong> for global and peer comparison. <button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Currency convertion" data-content="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."><i class="fa fa-info-circle"></i></button></small>
			</div>
		<?php } ?>
	</div>
	...
	<div class="tour-step tour-step-cost-activities-mapping">
		...
		<div class="row">
			<div class="col-md-6" style="margin-top: 50px">
				...
				<div class="form-group">
					<label for="cat_ingest" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Ingest" data-content="This activity covers processes related to receiving digital assets from an external source and preparing them for storage. Examples of activities that could fit into this activity category are: appraisal, submission agreement, validation of digital assets, metadata enrichment, preparing digital assets for storage within the archive.">Ingest <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
						...
						<span id="cat_ingest_feedback" class="slider-feedback" data-category="activities"><span class="feedback-currency-symbol"></span><span class="feedback-value editable-field"></span><span class="feedback-percentage-symbol"></span></span>
					</div>
				</div>
				<div class="form-group">
					<label for="cat_storage" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Archival storage" data-content="This activity covers processes related to storing, maintaining and retrieving the digital assets.Examples of activities that could fit into this activity category are: error checking, media migration, storage hierarchy management, providing disaster recovery capabilities.">Archival storage <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
						...
						<span id="cat_storage_feedback" class="slider-feedback" data-category="activities"><span class="feedback-currency-symbol"></span><span class="feedback-value editable-field"></span><span class="feedback-percentage-symbol"></span></span>
					</div>
				</div>
				<div class="form-group">
					<label for="cat_access" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Access" data-content="This activity covers processes related to accessing the stored digital assets. Examples of activities that could fit into this activity category are: providing access to digital assets and describing them meaningfully by adding relevant metadata to them.">Access <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
	...
	<div class="tour-step tour-step-cost-purchases-staff-mapping">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					<label for="cat_hardware" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Hardware" data-content="Machines and media used throughout the whole digital asset lifecycle. Hardware may receive, store, validate, make copies, migrate and disseminate digital assets.">Hardware <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
						...
						<span id="cat_hardware_feedback" class="slider-feedback" data-category="financial-accounting"><span class="feedback-currency-symbol"></span><span class="feedback-value editable-field"></span><span class="feedback-percentage-symbol"></span></span>
					</div>
				</div>
				<div class="form-group">
					<label for="cat_software" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Software" data-content="Programs used throughout the whole digital asset lifecycle. Software may receive, process, validate, create copies, migrate and disseminate digital assets.">Software <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
						...
						<span id="cat_software_feedback" class="slider-feedback" data-category="financial-accounting"><span class="feedback-currency-symbol"></span><span class="feedback-value editable-field"></span><span class="feedback-percentage-symbol"></span></span>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="cat_producer" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Producer" data-content="Any individual involved in preparing digital content for archiving. This may include researchers who generate and manage digital research data, or aggregate new subsets of existing data for new analysis; or government employees undertaking data collection and analysis. Producers may also include software developers and vendors producing code to enable analysis, manipulation and visualisation of digital content.">Producer <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
						...
						<span id="cat_producer_feedback" class="slider-feedback" data-category="financial-accounting"><span class="feedback-currency-symbol"></span><span class="feedback-value editable-field"></span><span class="feedback-percentage-symbol"></span></span>
					</div>
				</div>
				<div class="form-group">
					<label for="cat_it-developer" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="IT-developer" data-content="Staff members who develop software. Software engineers, programmers, system developers, coders.">IT-developer <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
						...
						<span id="cat_it-developer_feedback" class="slider-feedback" data-category="financial-accounting"><span class="feedback-currency-symbol"></span><span class="feedback-value editable-field"></span><span class="feedback-percentage-symbol"></span></span>
					</div>
				</div>
				<div class="form-group">
					<label for="cat_operations" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Operations" data-content="Staff members who execute technical tasks, for example testing digital material, operating the computers when migration occurs, burning optical disks, setting up robots, etc.), or administrative tasks, for example secretarial work, correspondence with content producers, execution of user requests at Access, etc.).">Operations <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
						...
						<span id="cat_operations_feedback" class="slider-feedback" data-category="financial-accounting"><span class="feedback-currency-symbol"></span><span class="feedback-value editable-field"></span><span class="feedback-percentage-symbol"></span></span>
					</div>
				</div>
				<div class="form-group" data-toggle="tooltip">
					<label for="cat_specialist" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Preservation specialist" data-content="Staff members who perform preservation actions and analyses, and provide specialist advice in relation to the digital repository, such as appraisal of digital material, execution of the preservation planning tasks, consultancy with users at Access, and other tasks requiring specialist preservation knowledge and academic skills.">Preservation<br/>specialist <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
						...
						<span id="cat_specialist_feedback" class="slider-feedback" data-category="financial-accounting"><span class="feedback-currency-symbol"></span><span class="feedback-value editable-field"></span><span class="feedback-percentage-symbol"></span></span>
					</div>
				</div>
				<div class="form-group">
					<label for="cat_manager" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Manager" data-content="Staff members who organise and plan the work of digital curation in their organisation. Make tactical and strategic decisions, have staff responsibility and do budgeting.">Manager <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
						...
						<span id="cat_manager_feedback" class="slider-feedback" data-category="financial-accounting"><span class="feedback-currency-symbol"></span><span class="feedback-value editable-field"></span><span class="feedback-percentage-symbol"></span></span>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-4 text-right">
				...
				<div class="form-group">
					<label for="cat_overhead" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Overhead" data-content="All costs pertaining to overhead costs such as building costs, electricity, water, etc.">Overhead <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
						...
						<span id="cat_overhead_feedback" class="slider-feedback" data-category="financial-accounting"><span class="feedback-currency-symbol"></span><span class="feedback-value editable-field"></span><span class="feedback-percentage-symbol"></span></span>
					</div>
				</div>
			</div>
	...
	<div class="form-group utils" style="margin-top:30px">
		<div class="col-sm-4">
			<div class="row tour-step tour-step-cost-save">
				<div class="col-sm-6">
					...
					<?php } ?>
		            <a class="btn btn-success btn-block btn-save-cost" href="javascript:void(0)" onclick="<?php if(isset($this->cost->cost_id)){ echo 'ccexUpdate(\'cost\', \'' . JRoute::_('index.php?view=collection&layout=edit&collection_id=' . $this->interval->collection()->collection_id . '&active_interval=' . $this->interval->interval_id . '#collectionCosts') . '\')'; }else{ echo 'ccexCreate(\'cost\', \'' . JRoute::_('index.php?view=collection&layout=edit&collection_id=' . $this->interval->collection()->collection_id . '&active_interval=' . $this->interval->interval_id . '#collectionCosts') . '\')'; } ?>">Save and close</span></a>
				</div>
				<div class="col-sm-6">
