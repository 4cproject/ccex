	...
	<div class="tour-step tour-step-cost-activities-mapping">
		...
		<div class="row">
			<div class="col-md-6" style="margin-top: 50px">
				...
				<div class="form-group">
					<label for="cat_access" class="col-sm-4 control-label"><button type="button" data-container="body" class="popover-dismiss tooltip-button popup-marker" data-toggle="popover" title="Access" data-content="This activity covers processes related to accessing the stored digitial assets. Examples of activities that could fit into this activity category are: providing access to digital assets and describing them meaningfully by adding relevant metadata to them.">Access <i class="fa fa-info-circle small"></i></button></label>
					<div class="col-sm-8">
