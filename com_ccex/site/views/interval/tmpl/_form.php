    <div class="interval-tab-row" style="margin-bottom: 30px">
        <div class="form-row">
            <div class="row tour-step tour-step-coll-year">
                <div class="col-md-4">
                    <div class="form-group margin-top-bottom-none">
        ...
        <div class="form-row">
            <div class="form-group margin-top-bottom-none tour-step tour-step-coll-staff">
        ...
        <div class="form-row">
            <div class="form-group margin-top-bottom-none tour-step tour-step-coll-data-volume">
        ...
        <div class="form-row">
            <div class="form-group margin-top-bottom-none tour-step tour-step-coll-number-of-copies">
    ...
    <div class="interval-tab-row">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="asset_unformatted_text"><div class="tour-step tour-step-coll-unformatted-text-info"><button type="button" class="popover-dismiss tooltip-button popup-marker" data-container="body" data-toggle="popover" data-placement="top" title="Unformatted text" data-content="Unformatted text, or plain text, is the contents of an ordinary sequential file readable as textual material without much processing. Examples: ISO 8859-1, ISO 8859-15, UTF-8, Windows Western 1252, IBM 437, ISO 646">Unformatted text <i class="fa fa-info-circle small"></i></button></div></label>
                    <div class="col-sm-8">
                        <span style="padding-bottom: 10px;" class="tour-step tour-step-coll-unformatted-text-slider">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="asset_graphics"><button type="button" class="popover-dismiss tooltip-button popup-marker" data-container="body" data-toggle="popover" data-placement="top" title="Graphics" data-content="Image file formats are standardized means of organising and storing digital images. Image files are composed of digital data in one of these formats that can be rasterised for use on a computer display or printer. An image file format may store data in uncompressed, compressed, or vector formats. Once rasterised, an image becomes a grid of pixels, each of which has a number of bits to designate its color equal to the color depth of the device displaying it. Examples: TIFF 6.0, PDF, PDF/A, JPEG, JPEG2000, SVG">Graphics <i class="fa fa-info-circle small"></i></button></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="asset_audio"><button type="button" class="popover-dismiss tooltip-button popup-marker" data-container="body" data-toggle="popover" data-placement="top" title="Sound" data-content="An audio file format is a file format for storing digital audio data on a computer system. The bit layout of the audio data (excluding metadata) is called the audio coding format and can be uncompressed, or compressed to reduce the file size, often using lossy compression. The data can be a raw bitstream in an audio coding format, but it is usually embedded in a container format or an audio data format with defined storage layer. Examples: WAVE PCM, MP3, FLAC, AAC">Sound <i class="fa fa-info-circle small"></i></button></label>
                    <div class="col-sm-8">
    ...
    <div class="form-group tour-step tour-step-coll-cost-units">
        <div class="col-sm-12">
            <h3>
                Cost units
            </h3>
