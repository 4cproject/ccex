...
<form class="form-horizontal" id="euroconvertionrateForm" role="form">
    <div class="row">
        <div class="form-group">
            <label style="text-align: right;" for="cost_description" class="col-sm-3 control-label">Currency Code</label>
            <div class="col-sm-4">
                <input type="text" <?php if(isset($this->conversion)){ echo "disabled"; } ?> class="form-control" id="conversion_code" name="conversion[code]" value="<?php if(isset($this->conversion->code)){ echo htmlspecialchars($this->conversion->code) ; } ?>" />
            </div>
        </div>
    </div>
    <div class="row">
        <div class="form-group">
            <label style="text-align: right;" for="cost_description" class="col-sm-3 control-label">Year</label>
            <div class="col-sm-4">
    ...
    <div class="row">
        <div class="form-group">
            <label style="text-align: right;" for="cost_description" class="col-sm-3 control-label">Rate</label>
            <div class="col-sm-4">
