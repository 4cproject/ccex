<ol class="breadcrumb">
    ...
    <li><a href="<?php echo JRoute::_('index.php?view=administration&layout=organization&organization_id=' . $this->collection->organization_id) ?>"><?php echo $this->collection->organization()->name; ?></a></li>
...
<p class="description"><?php echo $this->collection->description ?></p>
